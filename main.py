...
def audio(message):
    ...
    print(f'{datetime.now()}: Пользователь {message.from_user.first_name} ({message.from_user.id}) Нажал на кнопку audio')
...
def main(message):
    ...
    print(f'{datetime.now()}: Пользователь {message.from_user.first_name} ({message.from_user.id}) Нажал на кнопку start')
...
def help1(message):
    ...
    print(f'{datetime.now()}: Пользователь {message.from_user.first_name} ({message.from_user.id}) Нажал на кнопку help')
...
def send_photo(message):
    ...
    print(f'{datetime.now()}: Пользователь {message.from_user.first_name} ({message.from_user.id}) Нажал на кнопку удалить фото')
...
def id(message):
    ...
    print(f'{datetime.now()}: Пользователь {message.from_user.first_name} ({message.from_user.id}) Нажал на кнопку id')


@bot.message_handler(commands=["website","site"])
def website(message):
    webbrowser.open("https://ober1.st8.ru/")
    print(f'{datetime.now()}: Пользователь {message.from_user.first_name} ({message.from_user.id}) Нажал на кнопку site')
...
def get_photo(message):
    ...
    print(f'{datetime.now()}: Пользователь {message.from_user.first_name} ({message.from_user.id}) отправил фото')

@bot.message_handler()
def info(message):
    print(f'{datetime.now()}: Пользователь {message.from_user.first_name} ({message.from_user.id}) отправил сообщение id:{message.message_id-1} text:{message.text}')
